...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scene_2d__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scene_2d */ \"./js/modules/two/scene_2d.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"Scene2d\", function() { return _scene_2d__WEBPACK_IMPORTED_MODULE_0__[\"Scene2d\"]; });\n\n\n\n//# sourceURL=webpack://TBC/./js/modules/two/index.js?");

/***/ }),

/***/ "./js/modules/two/maths.js":
/*!*********************************!*\
  !*** ./js/modules/two/maths.js ***!
  \*********************************/
/*! exports provided: minAngleBetween, posterise */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"minAngleBetween\", function() { return minAngleBetween; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"posterise\", function() { return posterise; });\nconst minAngleBetween = function (a1, a2) {\n  return Math.atan2(Math.sin(a2 - a1), Math.cos(a2 - a1));\n};\n\nconst posterise = function (n, step) {\n  return Math.round(n / step) * step;\n};\n\n\n\n//# sourceURL=webpack://TBC/./js/modules/two/maths.js?");

/***/ }),

/***/ "./js/modules/two/node_2d.js":
/*!***********************************!*\
  !*** ./js/modules/two/node_2d.js ***!
  \***********************************/
/*! exports provided: Node2d */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Node2d\", function() { return Node2d; });\n/* harmony import */ var _maths__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./maths */ \"./js/modules/two/maths.js\");\n/**\r\n ** 2d draw node.\r\n **/\n\n\n\nclass Node2d {\n  constructor(root) {\n    this.root = root;\n    this.index = root.nodes.length;\n    this.x = Math.random() * root.cvs.width;\n    this.y = Math.random() * root.cvs.height;\n    this.vector = {\n      x: Math.random() * 2 - 1,\n      y: Math.random() * 2 - 1\n    };\n    this.speed = 20 + Math.random() * 20;\n    const mag = Math.hypot(this.vector.x, this.vector.y);\n    if (mag != 0) {\n      this.vector.x /= mag;\n      this.vector.y /= mag;\n    }\n  }\n\n  update(delta) {\n    this.x += this.vector.x * this.speed * delta;\n    this.y += this.vector.y * this.speed * delta;\n    if (this.x < 0 || this.x > this.root.cvs.width) {\n      this.vector.x *= -1;\n    }\n    if (this.y < 0 || this.y > this.root.cvs.height) {\n      this.vector.y *= -1;\n    }\n  }\n\n  draw(ctx) {\n    const snap = 32;\n    const x1 = _maths__WEBPACK_IMPORTED_MODULE_0__[\"posterise\"](this.x, snap);\n    const y1 = _maths__WEBPACK_IMPORTED_MODULE_0__[\"posterise\"](this.y, snap);\n    const rad = 4;\n    ctx.fillRect(x1 - rad / 2, y1 - rad / 2, rad, rad);\n    //ctx.beginPath();\n    //ctx.arc(x1, y1, rad, 0, Math.PI*2, false);\n    //ctx.fill();\n    const threshold = 60;\n    this.root.nodes.forEach(node => {\n      if (node.index != this.index) {\n        const x2 = _maths__WEBPACK_IMPORTED_MODULE_0__[\"posterise\"](node.x, snap);\n        const y2 = _maths__WEBPACK_IMPORTED_MODULE_0__[\"posterise\"](node.y, snap);\n        const mag = Math.hypot(x1 - x2, y1 - y2);\n        const angle = Math.round(Math.abs(Math.atan2(y2 - y1, x2 - x1)) * (180 / Math.PI));\n        if (mag < threshold && angle % 5 < 3) {\n          //ctx.globalAlpha = 1 - mag / threshold;\n          ctx.beginPath();\n          ctx.moveTo(x1, y1);\n          ctx.lineTo(x2, y2);\n          ctx.stroke();\n        }\n      }\n    });\n    ctx.globalAlpha = 1;\n  }\n}\n\n\n\n//# sourceURL=webpack://TBC/./js/modules/two/node_2d.js?");

/***/ }),

/***/ "./js/modules/two/scene_2d.js":
/*!************************************!*\
  !*** ./js/modules/two/scene_2d.js ***!
  \************************************/
/*! exports provided: Scene2d */
...
/***/ "./js/modules/world/chessboard/chess.js":
/*!**********************************************!*\
  !*** ./js/modules/world/chessboard/chess.js ***!
  \**********************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _chess__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chess */ \"./js/modules/world/chessboard/chess.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"Chess\", function() { return _chess__WEBPACK_IMPORTED_MODULE_0__[\"Chess\"]; });\n\n\n\n//# sourceURL=webpack://TBC/./js/modules/world/chessboard/index.js?");
...
/*!***********************************!*\
  !*** ./js/modules/world/index.js ***!
  \***********************************/
/*! exports provided: Camera, Lighting, Map */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
